...
class AlibabaAlihealthDrugYljgSaveentRequest(BaseRequest):

    def __init__(
        self,
        ref_ent_id: str = None,
        add_ent_req: object = None,
        lic_picture_byte: bytes = None
    ):
        """
            添加企业唯一标识
        """
        ...
        """
            新增企业信息
        """
        self._add_ent_req = add_ent_req
        """
            图片数据流。图片大小务必控制在2M以内
        """
        self._lic_picture_byte = lic_picture_byte
    ...
    @property
    def add_ent_req(self):
        return self._add_ent_req

    @add_ent_req.setter
    def add_ent_req(self, add_ent_req):
        if isinstance(add_ent_req, object):
            self._add_ent_req = add_ent_req
        else:
            raise TypeError("add_ent_req must be object")
    @property
    def lic_picture_byte(self):
        return self._lic_picture_byte

    @lic_picture_byte.setter
    def lic_picture_byte(self, lic_picture_byte):
        self._lic_picture_byte = lic_picture_byte

    def get_api_name(self):
        return "alibaba.alihealth.drug.yljg.saveent"
    ...
    def to_dict(self):
        ...
        if self._add_ent_req is not None:
            request_dict["add_ent_req"] = convert_struct(self._add_ent_req)

        return request_dict

    def get_file_param_dict(self):
        file_param_dict = {}
        if self._lic_picture_byte is not None:
            file_param_dict["lic_picture_byte"] = self._lic_picture_byte
        return file_param_dict

class AlibabaAlihealthDrugYljgSaveentAddress:
    def __init__(
        self,
        area_name: str = None,
        city_name: str = None,
...
class AlibabaAlihealthDrugYljgSaveentAddEntReqDto:
    def __init__(
        self,
        dict_region_detail: str = None,
        ent_org_type: int = None,
        store_addrs: list = None,
        ent_name: str = None,
        user_role_type: int = None,
        reg_addr: object = None,
        license_type: int = None,
        mobile_phone: str = None,
        org_code: str = None,
        tel: str = None,
        contact_psn_nm: str = None,
        email: str = None
    ):
        """
            企业详细注册地址
        """
        self.dict_region_detail = dict_region_detail
        """
        ...
        """
        self.ent_org_type = ent_org_type
        """
            企业其他地址省市区信息
        """
        ...
        """
            追溯业务负责人名称
        """
        self.contact_psn_nm = contact_psn_nm
        """
            追溯负责人联系邮箱
        """
        self.email = email
